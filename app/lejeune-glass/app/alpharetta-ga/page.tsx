...
export const metadata: Metadata = {
  title: 'Frameless Glass Showers & Railings Alpharetta, GA',
  description:
    'Custom frameless glass shower enclosures, glass railings, wine rooms & architectural glass installed in Alpharetta, GA. Veteran-owned. BBB A+ rated. Free estimate.',
  alternates: {
    canonical: 'https://www.lejeuneshowerglass.com/alpharetta-ga',
  },
  openGraph: {
    title: 'Frameless Glass Showers & Railings Alpharetta, GA | LeJeune Glass',
    description:
      'Custom frameless glass installations in Alpharetta, GA. Showers, railings, wine rooms & more. Free estimate.',
    url: 'https://www.lejeuneshowerglass.com/alpharetta-ga',
    ...
    '@graph': [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Alpharetta, GA', item: 'https://www.lejeuneshowerglass.com/alpharetta-ga' },
        ],
      },
    ],
  }
...
export default function AlpharettaPage() {
  const services = [
    ...
    { name: 'Commercial Glass', href: '/commercial', description: 'Office partitions, conference rooms, storefronts, and architectural glass for Alpharetta businesses.' },
  ]
  ...
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" style={{ padding: '1rem 2rem', fontSize: '0.75rem', color: 'rgba(242,241,237,0.4)', letterSpacing: '0.1em', background: '#0a0a0a' }}>
        ...
        <span style={{ color: 'rgba(242,241,237,0.7)' }}>Alpharetta, GA</span>
      </nav>
      ...
      <section style={{ background: '#0a0a0a', padding: '5rem 2rem 4rem', textAlign: 'center' }}>
        <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '0.65rem', letterSpacing: '0.35em', textTransform: 'uppercase', color: 'rgba(242,241,237,0.45)', marginBottom: '1.25rem' }}>
          LeJeune Glass — Serving Alpharetta
        </p>
        ...
        <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(2.75rem, 7vw, 5.5rem)', fontWeight: 300, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#F2F1ED', lineHeight: 1.05, marginBottom: '1.5rem' }}>
          Frameless Glass<br />Alpharetta, GA
        </h1>
        ...
        <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 'clamp(0.85rem, 2vw, 1rem)', color: 'rgba(242,241,237,0.6)', maxWidth: '540px', margin: '0 auto 2.5rem', lineHeight: 1.7 }}>
          Custom frameless glass showers, railings, wine rooms, and architectural glass — designed and installed for Alpharetta homeowners and businesses.
        </p>
      ...
      <section style={{ background: '#F2F1ED', padding: '5rem 5vw' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(1.75rem, 4vw, 2.75rem)', fontWeight: 300, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#0a0a0a', marginBottom: '1.5rem' }}>
            Alpharetta&apos;s Custom Glass Installer
          </h2>

          <p style={{ fontSize: '0.95rem', color: '#333', lineHeight: 1.85, marginBottom: '1.25rem' }}>
            Alpharetta is one of Metro Atlanta&apos;s fastest-growing luxury markets — and the homes here
            reflect it. From new construction in Avalon-area developments to established neighborhoods
            along Windward Parkway, Alpharetta homeowners invest in quality finishes. LeJeune Glass
            has been the custom glass installer of choice for Alpharetta residents looking for frameless
            shower enclosures, glass stair railings, wine room displays, and architectural glass features.
          </p>

          <p style={{ fontSize: '0.95rem', color: '#333', lineHeight: 1.85, marginBottom: '1.25rem' }}>
            We work directly with homeowners, custom builders, and interior designers throughout
            Alpharetta and North Fulton County. Every project is precision-measured and installed
            by our own team — never subcontracted.
          </p>
          ...
          <p style={{ fontSize: '0.95rem', color: '#333', lineHeight: 1.85 }}>
            ...
            Metro Atlanta. Your single point of contact from estimate through installation.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: '#F2F1ED', padding: '5rem 5vw' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(1.5rem, 3.5vw, 2.5rem)', fontWeight: 300, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#0a0a0a', marginBottom: '2.5rem' }}>
            Why Alpharetta Chooses LeJeune
          </h2>
      ...
      <section style={{ background: '#0a0a0a', padding: '3.5rem 5vw' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'rgba(242,241,237,0.5)', lineHeight: 1.8 }}>
            Windward, Avalon, Downtown Alpharetta, Milton, Crabapple, Cogburn Road,
            Haynes Bridge, Northpoint, and all surrounding North Fulton neighborhoods.
