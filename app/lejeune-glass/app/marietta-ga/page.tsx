...
export const metadata: Metadata = {
  title: 'Frameless Glass Showers & Railings Marietta, GA',
  description:
    'Custom frameless glass shower enclosures, glass railings, wine rooms & architectural glass installed in Marietta, GA. Veteran-owned. BBB A+ rated. Free estimate.',
  alternates: {
    canonical: 'https://www.lejeuneshowerglass.com/marietta-ga',
  },
  openGraph: {
    title: 'Frameless Glass Showers & Railings Marietta, GA | LeJeune Glass',
    description:
      'Custom frameless glass installations in Marietta, GA. Showers, railings, wine rooms & more. Veteran-owned. Free estimate.',
    url: 'https://www.lejeuneshowerglass.com/marietta-ga',
    ...
    '@graph': [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Marietta, GA', item: 'https://www.lejeuneshowerglass.com/marietta-ga' },
        ],
      },
    ],
  }
...
export default function MariettaPage() {
  const services = [
    ...
    { name: 'Commercial Glass', href: '/commercial', description: 'Office partitions, conference rooms, storefronts, and architectural glass for Marietta businesses.' },
  ]
  ...
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" style={{ padding: '1rem 2rem', fontSize: '0.75rem', color: 'rgba(242,241,237,0.4)', letterSpacing: '0.1em', background: '#0a0a0a' }}>
        ...
        <span style={{ color: 'rgba(242,241,237,0.7)' }}>Marietta, GA</span>
      </nav>
      ...
      <section style={{ background: '#0a0a0a', padding: '5rem 2rem 4rem', textAlign: 'center' }}>
        <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '0.65rem', letterSpacing: '0.35em', textTransform: 'uppercase', color: 'rgba(242,241,237,0.45)', marginBottom: '1.25rem' }}>
          LeJeune Glass — Serving Marietta
        </p>
        ...
        <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(2.75rem, 7vw, 5.5rem)', fontWeight: 300, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#F2F1ED', lineHeight: 1.05, marginBottom: '1.5rem' }}>
          Frameless Glass<br />Marietta, GA
        </h1>
        ...
        <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 'clamp(0.85rem, 2vw, 1rem)', color: 'rgba(242,241,237,0.6)', maxWidth: '540px', margin: '0 auto 2.5rem', lineHeight: 1.7 }}>
          Custom frameless glass showers, railings, wine rooms, and architectural glass — designed and installed for Marietta homeowners and businesses.
        </p>
      ...
      <section style={{ background: '#F2F1ED', padding: '5rem 5vw' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(1.75rem, 4vw, 2.75rem)', fontWeight: 300, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#0a0a0a', marginBottom: '1.5rem' }}>
            Marietta&apos;s Custom Glass Installer
          </h2>

          <p style={{ fontSize: '0.95rem', color: '#333', lineHeight: 1.85, marginBottom: '1.25rem' }}>
            Marietta homeowners know the value of a well-crafted home. From the historic neighborhoods
            near the Square to new construction in East Cobb and West Cobb, LeJeune Glass has been
            installing custom frameless glass throughout Marietta and the surrounding Cobb County area.
            Shower enclosures, glass stair railings, wine room displays, and commercial glass —
            all precision-measured and installed by our own team.
          </p>

          <p style={{ fontSize: '0.95rem', color: '#333', lineHeight: 1.85, marginBottom: '1.25rem' }}>
            We work with homeowners, builders, designers, and contractors across Marietta. Whether
            you&apos;re renovating a bathroom in a Whitlock Avenue bungalow or building a custom home
            in Timber Ridge, we bring the same standard of craftsmanship to every project.
          </p>
      ...
      <section style={{ background: '#0a0a0a', padding: '5rem 5vw' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
            {services.map((s) => (
              <a key={s.name} href={s.href} style={{ padding: '1.75rem', border: '1px solid rgba(242,241,237,0.1)', textDecoration: 'none', transition: 'border-color 0.2s' }}>
      ...
      <section style={{ background: '#0a0a0a', padding: '3.5rem 5vw' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '1.4rem', fontWeight: 300, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#F2F1ED', marginBottom: '1rem' }}>
            Neighborhoods We Serve in Marietta
          </h2>
          <p style={{ fontSize: '0.85rem', color: 'rgba(242,241,237,0.5)', lineHeight: 1.8 }}>
            East Cobb, West Cobb, Marietta Square, Kennesaw Mountain, Dallas Highway corridor,
            Roswell Road, Lower Roswell, Powers Ferry, and all surrounding Marietta neighborhoods.
