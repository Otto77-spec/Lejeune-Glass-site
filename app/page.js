...
<section id="hero" className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-charcoal">
<img
src="/images/hero.jpg"
...
<section id="projects" className="py-28 px-8 md:px-12 bg-warm-white">
...
{projects.map((p, i) => (
<div key={i} className="project-card group relative overflow-hidden rounded bg-charcoal-light cursor-pointer shadow-[0_8px_32px_rgba(0,0,0,0.10)] hover:shadow-[0_20px_56px_rgba(0,0,0,0.22)] transition-shadow duration-300" style={{ height: "380px" }}>
...
<section id="services" className="py-28 px-8 md:px-12 bg-charcoal">
<div className="text-center mb-20">
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-px bg-white/[0.06] max-w-screen-xl mx-auto border border-white/[0.06]">
{services.map((s, i) => (
<div key={i} className="bg-charcoal px-8 py-12 flex flex-col gap-5 transition-all duration-300 hover:bg-charcoal-mid group">
<div className="w-8 h-px bg-gold transition-all duration-300 group-hover:w-14" />
...
<section id="contact" className="py-28 px-8 md:px-12 bg-[#F5F4F1]">
<div className="text-center mb-20">
...
<input id="name" name="name" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "0.88rem", fontWeight: 400, color: "#222", background: "white", border: "1px solid #ccc", padding: "14px 16px", outline: "none", borderRadius: "2px", letterSpacing: "0.04em", transition: "border-color 0.2s" }} placeholder="John Smith" value={formData.name} onChange={handleChange} required />
</div>
<div className="flex flex-col gap-2">
...
<input id="phone" name="phone" type="tel" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "0.88rem", fontWeight: 400, color: "#222", background: "white", border: "1px solid #ccc", padding: "14px 16px", outline: "none", borderRadius: "2px", letterSpacing: "0.04em", transition: "border-color 0.2s" }} placeholder="(404) 555-0100" value={formData.phone} onChange={handleChange} required />
</div>
</div>
<div className="flex flex-col gap-2">
...
<button type="submit" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "0.72rem", fontWeight: 600, letterSpacing: "0.22em", textTransform: "uppercase", padding: "18px 40px", background: "#121212", color: "white", border: "none", borderRadius: "2px", cursor: "pointer", alignSelf: "flex-start", marginTop: "8px", transition: "background 0.2s" }}>
...
{["ig", "fb", "hz"].map((s) => (
<a key={s} href="#" style={{ width: "38px", height: "38px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.75rem", transition: "all 0.2s" }}>
{s}
</a>
))}
</div>
